...
import { filters as filtersData, folders as foldersData, labels as labelsData, mails as mailsData, settings as settingsData } from 'projects/fuse/src/app/mock-api/apps/mailbox/data';
